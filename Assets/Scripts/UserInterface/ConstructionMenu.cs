...
public class ConstructionMenu : MonoBehaviour
{
    ...
    public void InitializeConstructionButton(UnityAction<Unit, Vector3> constructionCallback,UnityAction stateMachineCallback, Unit unit, Vector3 constructionPosition)
    {
        ...
        constButton.button.onClick.AddListener(() => constructionCallback(unit, constructionPosition));
