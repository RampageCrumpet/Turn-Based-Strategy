...
public class RoomManager : NetworkRoomManager
{
    ...
    { 
        /*//We loaded the RoomScene
        if(SceneManager.GetActiveScene().name == RoomScene)
        {
            readyStatusPanel = FindObjectOfType<ReadyStatusPanel>();
            if (readyStatusPanel == null)
                Debug.LogError("RoomManager is unable to find a ReadyStatusPanel in our lobby scene.");
        }*/
    }
